...
thumbnail: "assets/img/adaptive_prediction/Adaptive_Framework.png"
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_Framework.png?raw=true" alt="Adaptive CFD-POD-DL framework" width="85%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_Geometry_Mesh.png?raw=true" alt="Computational geometry and mesh" width="90%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_CFD_Validation.png?raw=true" alt="Validation of drag coefficient, base-pressure coefficient and Strouhal number" width="55%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_RMSE_Re200.png?raw=true" alt="RMSE for Re=200 baseline POD-DL prediction" width="60%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_RMSE_Re300.png?raw=true" alt="RMSE for Re=300 baseline POD-DL prediction" width="60%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_RMSE_Re300_adaptive.png?raw=true" alt="RMSE for scheduled adaptive prediction at Re=300" width="60%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_Event_Triggered_Prediction.png?raw=true" alt="Event-triggered uncertainty monitoring" width="90%">
</p>
...
<p style="text-align: center;">
    <img src="https://github.com/modelflows/modelflowsapp/blob/research/CFD/Accelerate_CFD/assets/img/adaptive_prediction/Adaptive_Inlet_Variation.png?raw=true" alt="Adaptive prediction under varying inlet velocity" width="90%">
</p>
