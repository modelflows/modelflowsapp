...
If you are an unexperienced user, and would like to learn how this software works, we highy recommend you download the web-browser version, which serves as a demo. The first part of the following tutorial explains step by step how to "install" and start-up ModelFLOWs-app.
