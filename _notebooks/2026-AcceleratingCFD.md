...
A step-by-step tutorial showing how to use ROMIA from snapshot extraction to modal reconstruction and error analysis is available here. <a href="{{ '/software/tutorials/romia-user-guide/' | relative_url }}">
