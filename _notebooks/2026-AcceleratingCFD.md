...
A step-by-step tutorial describing the full workflow is available here. <a href="{{ '/software/tutorials/2026-accelerateCFD-tutorial/' | relative_url }}">
...
A step-by-step tutorial showing how to use ROMIA from snapshot extraction to modal reconstruction and error analysis is available here. <a href="{{ '/software/tutorials/urban-3d-reconstruction/' | relative_url }}">
