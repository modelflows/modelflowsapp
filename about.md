...
<!-- Guillermo Barragan -->
  ...
  <!-- Paul Jeanney -->
  <div class="col-md-4 mb-5">
    <img src="{{ '/assets/img/team/paul_jeanney.jpg' | relative_url }}" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #eee;" alt="Paul Jeanney">
    <h4>Paul Jeanney</h4>
    <p class="text-muted">PhD Candidate</p>
    <div class="d-flex justify-content-center align-items-center mt-2" style="gap: 12px;">
...
<!-- Christian Amor -->
  <div class="col-md-4 mb-5">
    <img src="{{ '/assets/img/team/christian_amor.jpg' | relative_url }}" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #eee;" alt="Christian Amor">
    <h4>Christian Amor</h4>
    <p class="text-muted">PhD Candidate</p>
    <div class="d-flex justify-content-center align-items-center mt-2" style="gap: 12px;">
...
<!-- Miguel Ríos -->
  <div class="col-md-4 mb-5">
    ...
    <p class="text-muted">PhD Candidate</p>
    <div class="d-flex justify-content-center align-items-center mt-2" style="gap: 12px;">
      <a href="https://linkedin.com/in/miguel-rios-perez/" title="LinkedIn" target="_blank"><img src="{{ '/assets/img/logos/linkedin.png' | relative_url }}" alt="LinkedIn" style="width: 20px;"></a>
  ...
  <!-- Ander Sánchez -->
  <div class="col-md-4 mb-5">
    <img src="{{ '/assets/img/team/ander_sanchez.jpg' | relative_url }}" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #eee;" alt="Ander Sánchez">
    <h4>Ander Sánchez</h4>
    <p class="text-muted">MSc student</p>
    <div class="d-flex justify-content-center align-items-center mt-2" style="gap: 12px;">
      <a href="https://www.linkedin.com/in/ander-sánchez-muñoz-30484b359/" title="LinkedIn" target="_blank"><img src="{{ '/assets/img/logos/linkedin.png' | relative_url }}" alt="LinkedIn" style="width: 20px;"></a>
      <a href="https://github.com/sanchez147304" title="GitHub" target="_blank"><img src="{{ '/assets/img/logos/github.svg' | relative_url }}" alt="GitHub" style="width: 20px;"></a>
    </div>
  </div>

  <!-- Carlos Sainz -->
  <div class="col-md-4 mb-5">
    <img src="{{ '/assets/img/team/carlos_sainz.jpg' | relative_url }}" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #eee;" alt="Carlos Sainz">
    <h4>Carlos Sainz</h4>
    <p class="text-muted">MSc student</p>
    <div class="d-flex justify-content-center align-items-center mt-2" style="gap: 12px;">
      <a href="https://www.linkedin.com/in/carlos-sainz-garcia/" title="LinkedIn" target="_blank"><img src="{{ '/assets/img/logos/linkedin.png' | relative_url }}" alt="LinkedIn" style="width: 20px;"></a>
      <a href="https://github.com/sainzgcarlos" title="GitHub" target="_blank"><img src="{{ '/assets/img/logos/github.svg' | relative_url }}" alt="GitHub" style="width: 20px;"></a>
    </div>
  </div>
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item d-flex justify-content-between align-items-center">
        <div>
          ...
          <small class="text-muted">PhD Candidate (2020 &ndash; 2024)</small>
        </div>
        <div class="text-end ps-3">
