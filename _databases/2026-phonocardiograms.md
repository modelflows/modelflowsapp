...
All the data comes from 9 differents databases which gives PhysioNet more variabiliy. The recordings take a time between 5 and 122 seconds, and are resampled to 2000 Hz.
