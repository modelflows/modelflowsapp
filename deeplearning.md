...
The forecasting can be conducted using either a [fixed temporal horizon](https://modelflows.github.io/modelflowsapp/modaldecomposition/#pattern-hosvd), where the model predicts a predetermined number of snapshots simultaneously, or an [autoregressive](https://modelflows.github.io/modelflowsapp/modaldecomposition/#pattern-hosvd) approach, where multiple predictions are iteratively computed by feeding previously generated outputs back into the model.
