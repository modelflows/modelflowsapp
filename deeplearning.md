...
<!-- [A. Sengupta, R. Abadía-Heredia, A. Hetherington, J. Miguel Perez, S. Le Clainche - " Hybrid machine learning models based on physical patterns to accelerate CFD simulations: a short guide on autoregressive models"](https://doi.org/10.48550/arXiv.2404.17884)  -->
<!-- Download the codes [*here*](https://github.com/modelflows/notebooks/blob/main/deep-learning/.....zip) or to run it in [*Colab*].  -->
